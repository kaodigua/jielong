...
var allSelected = require('../../model/selectData.js')
var cydata = require('../../model/cydata.js')
Page({
  ...
  generateNewData() {
    ...
    this.data.curImgUrl = this.data.basePath + this.data.cydata[index].img;
    this.data.curCorrectText = this.data.cydata[index].answer;
    this.generateText();
    //更新数据
    this.setData({
  ...
  onLoad: function (options) {
    ...
    //生成随机排序辅助数组
    for (let i = 0; i < this.data.cydata.length; i++) {
